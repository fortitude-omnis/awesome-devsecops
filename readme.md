...
- [OSPulse CLI](https://github.com/Fortitude-Group/ospulse-cli) - _Fortitude Omnis_ - a free, no-account CLI and GitHub Action that emits a CycloneDX or SPDX SBOM and gates CI on dependencies with active exploitation (CISA KEV and OSV).
